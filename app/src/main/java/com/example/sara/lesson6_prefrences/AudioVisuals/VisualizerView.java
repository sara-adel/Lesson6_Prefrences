package com.example.sara.lesson6_prefrences.AudioVisuals;
...
import com.example.sara.lesson6_prefrences.R;

/**
 * Created by Sara on 11/29/2017.
 */
...
public class VisualizerView extends View {
    ...
    //This method is called by the {@link AudioInputReader} class to pass in the current fast Fourier transform bytes.
    // The array is then taken, divided up into segments, and each segmentis averaged to determine how big of a visual
    // spike to display.
